...
function preload(){
  ...
  police = loadAnimation("../images/sprites/Police_animation/1.png", "../images/sprites/Police_animation/2.png", "../images/sprites/Police_animation/3.png");
}
...
function setup() {
  ...
  //COP CAR SPRITE
  cop = createSprite(700,250,40,40);
  cop.addAnimation("emergency2",police);
  cop.scale = 0.5;
  cop.rotation = 270;

  cop2 = createSprite(700,250,40,40);
  cop2.addAnimation("emergency2",police);
  cop2.scale = 0.5;
  cop2.rotation = 270;
...
//THE ANIMATION SEQUENCE
  ...
  if(amb.position.x < 200){
    car.velocity.y = -1;
    cop.velocity.x = -3;
  } 

  if(car.position.y === 370){
    car.setVelocity(0,0);
  ...
  if(amb.removed === true) {
    ...
    textSize(16);
    text("It isn't safe to proceed without waiting to check for other emergency vehicles",40,285);
  } 
